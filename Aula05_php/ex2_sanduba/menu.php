...
<style>
    /* Estiliza o corpo para centralizar o formulário */
    body {
        background-color: #f8f9fa; /* Um cinza claro de fundo */
    }

    /* Transforma o <form> em um "card" centralizado */
    form {
        max-width: 600px;       
        margin: 40px auto;     
        padding: 30px;            
    ...
    /* Estiliza a pergunta principal do formulário */
    ...
    /* Cria um container para cada opção (radio/checkbox) */
    .form-option {
        padding: 15px;
    ...
    /* Estiliza os inputs (radio/checkbox) */
    ...
    /* Estiliza o botão de Enviar/Próximo */
    ...
    form input[type="submit"]:hover {
     ...
     .bg-custom-purple {
        background-image: linear-gradient(90deg, #390a84ff, #5d2390ff);
    }
  </style>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <?php else: ?>
              <a class="nav-link" href="local_1_.php">Local</a>
            <?php endif; ?>
            ...
            <?php else: ?>
              <a class="nav-link" href="pao_2_.php">Tipo de Pão</a>
            <?php endif; ?>
            ...
            <?php else: ?>
              <a class="nav-link" href="carne_3_.php">Tipo de Carne</a>
            <?php endif; ?>
            ...
            <?php else: ?>
              <a class="nav-link" href=vegetais_4_.php>Vegetais</a>
            <?php endif; ?>
            ...
            <?php else: ?>
              <a class="nav-link" href=queijos_5_.php>Queijos</a>
            <?php endif; ?>
            ...
            <?php else: ?>
              <a class="nav-link" href=molhos_6_.php>Molhos</a>
            <?php endif; ?>
