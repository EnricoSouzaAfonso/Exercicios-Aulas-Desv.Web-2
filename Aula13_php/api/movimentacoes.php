...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // 1. Busca o estado atual do produto para comparar
    ...
    // 2. Monta a descrição da alteração
    $alteracoes_log = [];
    ...
    // 3. Atualiza o produto na tabela principal
    ...
    // 4. Salva o log na tabela de alterações (se houve alguma)
