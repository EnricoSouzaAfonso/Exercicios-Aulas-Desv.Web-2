...
if (isset($_SESSION['nome'])) {
    ...
    /*
    Preferi utilizar este método de redirecionamento('<meta http-equiv="refresh" content="5;url=primeira.php">'), pois 
    o header inutilizaria oque eu deixava escrito na página, confirmando ao usuário que a sessão 
    foi apagada. aprendi e vi e apliquei o uso do header, mas como falei, não gostei do resultado. 
    Por isso usei esse outro método.
    */
